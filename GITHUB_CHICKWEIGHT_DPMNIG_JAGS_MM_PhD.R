...
data("ChickWeight")
ChickWeight1 <- sapply(ChickWeight, as.numeric) # Convert all columns to numeric
x <- ChickWeight1[,-c(3,4)]
x <- scale(x)
true_lab <- ChickWeight$Diet    # Use the 'class' column as the true labels
