...
data("Boston")
x <- Boston[,-4]  # Exclude the 'class' column for clustering
x <- scale(x)
true_lab <- Boston$chas    # Use the 'class' column as the true labels
...
true_lab <- as.numeric(factor(Boston[,4], levels = c("non-tract B.R", "tract B.R"))) 
true_lab
